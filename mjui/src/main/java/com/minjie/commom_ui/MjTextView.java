...
public class MjTextView extends LinearLayout {
    ...
    public MjTextView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MjText);
        int firstColor = a.getColor(R.styleable.MjText_color1, context.getResources().getColor(R.color.black));
        int secondColor = a.getColor(R.styleable.MjText_color2, context.getResources().getColor(R.color.black));
        needColon = a.getBoolean(R.styleable.MjText_needColon, true);
        strTitle = a.getString(R.styleable.MjText_text1);
        strContent = a.getString(R.styleable.MjText_text2);
        textSize1 = a.getInteger(R.styleable.MjText_textSize1, 12);
        textSize2 = a.getInteger(R.styleable.MjText_textSize2, 12);
        bold1 = a.getBoolean(R.styleable.MjText_bold1, true);
        bold2 = a.getBoolean(R.styleable.MjText_bold2, true);
        a.recycle();
